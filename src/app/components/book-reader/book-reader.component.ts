    ...
    loadNewFormatChapter(
        ...
        Promise.all([
            ...
            .then(([targetContent, nativeContent]) => {
                ...
                const furthestPage =
                    this.progressService.getFurthestPage(chapterId);
